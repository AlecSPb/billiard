package kr.appfactory.billiardya;
...
public class WoodFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    Activity activity;
    String target = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=relevance&videoSyndicated=true&maxResults=5&key=AIzaSyBn4fOG4zKOYVbYtcMtGj8gGsVVpTYb68g&safeSearch=strict&type=video&q=4구당구 강좌&pageToken=";
    ...
    public void onScrollStateChanged(AbsListView absListView, int scrollState) {
        ...
        if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && lastItemVisibleFlag && mLockListView == false) {
            ...
            String target = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=relevance&videoSyndicated=true&maxResults=10&key=AIzaSyBn4fOG4zKOYVbYtcMtGj8gGsVVpTYb68g&safeSearch=strict&type=video&q=4구당구 강좌&pageToken=";
